...
function placeCanvas(center){
    if(!center) {
        onScreenCanvasContainer.classList.add("center_canvas")
        offScreenCanvasContainer.classList.add("center_canvas")
    }
    else {
        onScreenCanvasContainer.classList.remove("center_canvas")
        offScreenCanvasContainer.classList.remove("center_canvas")
    }
}
...
function showCnvElements(show){
    if(show){
        ...
        offScreenCanvasContainer.style.display = "none";
        placeCnvBtn.style.display = "none";
    }
}

// console.log(document.querySelector("#canvasFilters"))